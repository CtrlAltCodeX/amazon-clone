    ...
    <div className="grid">
      <div className="grid p-5 bg-[#131921] grid-cols-[300px,auto,325px] text-white items-center">
        ...
        <div className="flex">
          ...
          <button class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center border border-gray-300 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 text-dark dark:border-gray-600 rounded-se-lg rounded-ee-lg bg-[#febd69]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
